...
The dataset is on HuggingFace at [kaushikpraka/wm-smallarea_merged](https://huggingface.co/datasets/kaushikpraka/wm-smallarea_merged), viewable in the [LeRobot visualizer](https://huggingface.co/spaces/lerobot/visualize_dataset).
